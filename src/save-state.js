    ...
    methods: {
        loadState() {
            const savedState = getSavedState(
                this.getSaveStateConfig().cacheKey
            );
        ...
        attributeIsManagedBySaveState(attribute) {
            if (
                this.getSaveStateConfig().ignoreProperties &&
                this.getSaveStateConfig().ignoreProperties.indexOf(
                    attribute
                ) !== -1
            ) {
                return false;
            ...
            return (
                this.getSaveStateConfig().saveProperties.indexOf(attribute) !==
                -1
            );
        },
